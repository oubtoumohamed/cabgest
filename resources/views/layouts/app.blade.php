...
<head>
    ...
    <!-- jsvectormap css -->
    <link href="{{ asset('assets/libs/jsvectormap/css/jsvectormap.min.css') }}?v=1" rel="stylesheet" type="text/css" />
    <!--Swiper slider css-->
    <link href="{{ asset('assets/libs/swiper/swiper-bundle.min.css') }}?v=1" rel="stylesheet" type="text/css" />
    <!-- Layout config Js -->
    ...
    <link href="{{ asset('assets/libs/sweetalert2/sweetalert2.min.css') }}?v=1" rel="stylesheet" type="text/css" />
    <!-- custom Css-->
...
<body class="fullscreen-enable">
    ...
    {{--
    <div class="loading" style="margin: auto;background: rgb(241, 242, 243);display: block;shape-rendering: auto;position: absolute;top: 0;left: 0;z-index: 9999;right: 0;width: 100%;height: 100vh; line-height: 50vh;"> 
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto;display: block; shape-rendering: auto; height: 100%;" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"> <rect x="17.5" y="30" width="15" height="40" fill="#1d3f72"> <animate attributeName="y" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.5;1" values="18;30;30" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.2s"></animate> <animate attributeName="height" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.5;1" values="64;40;40" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.2s"></animate> </rect> <rect x="42.5" y="30" width="15" height="40" fill="#5699d2"> <animate attributeName="y" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.5;1" values="20.999999999999996;30;30" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.1s"></animate> <animate attributeName="height" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.5;1" values="58.00000000000001;40;40" keySplines="0 0.5 0.5 1;0 0.5 0.5 1" begin="-0.1s"></animate> </rect> <rect x="67.5" y="30" width="15" height="40" fill="#d8ebf9"> <animate attributeName="y" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.5;1" values="20.999999999999996;30;30" keySplines="0 0.5 0.5 1;0 0.5 0.5 1"></animate> <animate attributeName="height" repeatCount="indefinite" dur="1s" calcMode="spline" keyTimes="0;0.5;1" values="58.00000000000001;40;40" keySplines="0 0.5 0.5 1;0 0.5 0.5 1"></animate> </rect></svg> 
    </div>
    --}}
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
                                    <img src="" alt="" class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr" title="German">
                                    <img src="" alt="" class="me-2 rounded" height="18"> <span class="align-middle">Deutsche</span>
                                </a>
            ...
            <div id="scrollbar" class="h-100" data-simplebar="">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav" data-simplebar="">
                        ...
                        <li class="menu-title"><span data-key="t-menu">{{ __('global.quicklink') }}</span></li>
                        <li class="nav-item ">
                            <a class="nav-link menu-link home" href="{{ route('home') }}">
                                <i class="ri-dashboard-fill"></i> <span>{{ __('global.dashboard') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#siderdv" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="siderdv">
                                <i class="mdi mdi-account-circle-outline"></i> <span data-key="t-dashboards">{{ __('global.rdv') }}</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidedossier" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidedossier">
                                <i class="mdi mdi-account-circle-outline"></i> <span data-key="t-dashboards">{{ __('global.dossier') }}</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidedossier">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('dossier_create') }}" class="nav-link dossier_create dossier_edit">{{ __('dossier.create') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('dossier_today') }}" class="nav-link dossier_today">{{ __('dossier.today') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('dossier') }}" class="nav-link dossier">{{ __('dossier.list') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </li> 

                        <li class="menu-title"><span data-key="t-menu">{{ __('global.settings') }}</span></li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidehr" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidehr">
                                <i class="mdi mdi-account-circle-outline"></i> <span data-key="t-dashboards">{{ __('global.hr') }}</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidehr">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('groupe') }}" class="nav-link groupe">{{ __('groupe.list') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('user') }}" class="nav-link user">{{ __('user.list') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('leave') }}" class="nav-link leave">{{ __('leave.list') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </li> 
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidesettings" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidesettings">
                                <i class="mdi mdi-account-circle-outline"></i> <span data-key="t-dashboards">{{ __('global.settings') }}</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidesettings">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('analyse') }}" class="nav-link analyse">{{ __('analyse.list') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('caisse') }}" class="nav-link caisse">{{ __('caisse.list') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('patient') }}" class="nav-link patient">{{ __('patient.list') }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('motif') }}" class="nav-link motif">{{ __('motif.list') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </li> 
    ...
    <script src="{{ asset('assets/js/app.js') }}?v=0.9"></script>
    <script type="text/javascript">
    jQuery(document).ready(function(){

        //$('.loading').fadeOut(2000)
            
        $element__ = $('.nav-link.{{ \Request::route()->getName() }}');
